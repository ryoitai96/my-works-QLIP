...
import { fetchClientDashboardStats, type DashboardStats } from '../api';
import { authStore } from '../../auth/auth-store';
import { isClientHR } from '../../auth/role-check';
import { useTenantServices } from '../../auth/tenant-services-context';
...
export function ClientDashboardPageContent() {
  ...
  return (
    <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
      ...
      {/* Thanks */}
      {isServiceEnabled('thanks') && <StatCard
        title="サンクスカード"
      ...
      {/* Health Check */}
      {isServiceEnabled('health_check') && <StatCard
        title="体調チェック"
